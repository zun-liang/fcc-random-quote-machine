        ...
        <div>
          <div>
            <IconBox
              id="tweet-quote"
              color={color}
              href={`https://twitter.com/intent/tweet?hashtags=quotes,freecodecamp&text=${tweetContent}`}
              target="_blank"
            >
              <Icon icon={faTwitter} />
            </IconBox>
            <IconBox
              id="tumblr-quote"
              color={color}
              href={`http://tumblr.com/widgets/share/tool?posttype=quote&tags=quotes,freecodecamp&content=${quote.quote}&&caption=${quote.author}&canonicalUrl=https%3A%2F%2Fwww.tumblr.com%2Fbuttons`}
              target="_blank"
            >
              <Icon icon={faTumblr} />
            </IconBox>
          </div>
          <Button id="new-quote" color={color} onClick={handleClick}>
            New Quote
          </Button>
        </div>
      </QuoteBox>
